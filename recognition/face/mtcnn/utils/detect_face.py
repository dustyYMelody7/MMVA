...
def detect_face(imgs, minsize, pnet, rnet, onet, threshold, factor, device):
    ...
    batch_boxes, batch_points = np.array(batch_boxes, dtype=np.ndarray), np.array(batch_points, dtype=np.ndarray)
    # print("points:", batch_points)
...
def extract_face(img, landmark, image_size=(112, 112)):
    ...
    face = warp_and_crop_face(np.array(img), landmark, refrence, crop_size=image_size)
